...
//--------------------------------------------------------------------------------------------------
template <class T>
class counting_iterator final : public iterator_facade<counting_iterator<T>> {
 ...
 public:
  ...
  bool equal_to(counting_iterator other) const noexcept {
  ...
  int distance_to(counting_iterator other) const noexcept {
