 ...
 */
#include "sxt/curve_bng1_32/operation/scalar_multiply.h"
...
TEST_CASE("scalar multiplication returns") {
  SECTION("the identity if the scalar is zero") {
    ...
    scalar_multiply255(ret, cn3cn::generator_p2_v, a.data());

    REQUIRE(cn3t::element_p2::identity() == ret);
  }
  ...
  SECTION("2G if the scalar is two") {
    ...
    cn3t::element_p2 ret_scalar;
    scalar_multiply255(ret_scalar, cn3cn::generator_p2_v, a.data());

    cn3t::element_p2 g_2_add;
    add(g_2_add, cn3cn::generator_p2_v, cn3cn::generator_p2_v);

    cn3t::element_p2 g_2_double;
    double_element(g_2_double, cn3cn::generator_p2_v);

    REQUIRE(ret_scalar == g_2_add);
    REQUIRE(ret_scalar == g_2_double);
    REQUIRE(ret_scalar != cn3t::element_p2::identity());
  }
  ...
  SECTION("4G if the scalar is four") {
    ...
    cn3t::element_p2 g_2;
    cn3t::element_p2 g_4;
    add(g_2, cn3cn::generator_p2_v, cn3cn::generator_p2_v);
