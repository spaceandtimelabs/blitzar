...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
static void scalar_multiply_impl(cn3t::element_p2& h, const cn3t::element_p2& p,
                                 const uint8_t q[32], const int first_one_byte,
                                 const int first_one_bit) noexcept {
  cn3t::element_p2 acc{cn3t::element_p2::identity()};
...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
void scalar_multiply255(cn3t::element_p2& h, const cn3t::element_p2& p,
                        const uint8_t q[32]) noexcept {
