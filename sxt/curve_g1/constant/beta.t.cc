...
TEST_CASE("the beta constant") {
  ...
  SECTION("should be equal to the following big endian byte representation") {
    bool is_below_modulus{true};
    std::array<uint64_t, 6> h{};
    constexpr std::array<uint8_t, 48> s{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5f, 0x19,
                                        0x67, 0x2f, 0xdf, 0x76, 0xce, 0x51, 0xba, 0x69, 0xc6, 0x07,
                                        0x6a, 0x0f, 0x77, 0xea, 0xdd, 0xb3, 0xa9, 0x3b, 0xe6, 0xf8,
                                        0x96, 0x88, 0xde, 0x17, 0xd8, 0x13, 0x62, 0x0a, 0x00, 0x02,
