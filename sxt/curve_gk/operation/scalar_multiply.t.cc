...
TEST_CASE("scalar multiplication returns") {
  SECTION("the identity if the scalar is zero") {
    ...
    scalar_multiply255(ret, cgkcn::generator_p2_v, a.data());

    REQUIRE(cgkt::element_p2::identity() == ret);
  }
  ...
  SECTION("2G if the scalar is two") {
    ...
    cgkt::element_p2 ret_scalar;
    scalar_multiply255(ret_scalar, cgkcn::generator_p2_v, a.data());

    cgkt::element_p2 g_2_add;
    add(g_2_add, cgkcn::generator_p2_v, cgkcn::generator_p2_v);

    cgkt::element_p2 g_2_double;
    double_element(g_2_double, cgkcn::generator_p2_v);

    REQUIRE(ret_scalar == g_2_add);
    REQUIRE(ret_scalar == g_2_double);
    REQUIRE(ret_scalar != cgkt::element_p2::identity());
  }
  ...
  SECTION("4G if the scalar is four") {
    ...
    cgkt::element_p2 g_2;
    cgkt::element_p2 g_4;
    add(g_2, cgkcn::generator_p2_v, cgkcn::generator_p2_v);
