...
#include "sxt/fieldgk/base/subtract_p.h"
...
// add
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE inline void add(fgkt::element& h, const fgkt::element& f,
                              const fgkt::element& g) noexcept {
  uint64_t h_tmp[4] = {};
  uint64_t carry{0};
