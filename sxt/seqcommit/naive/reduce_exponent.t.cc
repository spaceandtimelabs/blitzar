...
TEST_CASE("Test 1 - We can verify that reduce does not change input array A when A < p") {
    ...
    // s = p - 1 (decimal)
    // s % p = p - 1 (decimal)
    std::array<unsigned long long, 4> s = {6346243789798364140ull, 1503914060200516822ull, 0ull, 1152921504606846976ull};
...
TEST_CASE("Test 2 - We can verify that reduce change input array A when A >= p") {
    ...
    // s = p (decimal)
    // s % p = 0 (decimal)
    std::array<unsigned long long, 4> s = {6346243789798364141ull, 1503914060200516822ull, 0ull, 1152921504606846976ull};
...
TEST_CASE("Test 3 - We can verify that reduce change input array A when A >= p") {
    ...
    // s = p + 103 (decimal)
    // s % p = 103 (decimal)
    std::array<unsigned long long, 4> s = {6346243789798364244ull, 1503914060200516822ull, 0ull, 1152921504606846976ull};
...
TEST_CASE("Test 4 - We can verify that reduce correctly change input array A even when A is the maximum possible value") {
    ...
    std::array<unsigned long long, 4> s = {18446744073709551615ull, 18446744073709551615ull, 18446744073709551615ull, 18446744073709551615ull};
