...
TEST_CASE("Test 8 - We can verify that adding columns with different word size and number of rows") {
    ...
    // B = p (decimal)
    // C = p + p (decimal)
    std::array<unsigned long long, 4> a = {6346243789798364141ull, 1503914060200516822ull, 1ull, 1152921504606846976ull};
    std::array<unsigned int, 2> b = {123, 733};
    std::array<unsigned char, 3> c = {121, 200, 135};
    std::array<unsigned long long, 4> d = {6346243789798364385ull, 1503914060200517755ull, 136ull, 1152921504606846976ull};
