...
void reduce_exponent(unsigned char s[32]) noexcept {
    ...
    int64_t s1  = 2097151 & (basbt::load_4(s + 2) >> 5);
    int64_t s2  = 2097151 & (basbt::load_3(s + 5) >> 2);
    int64_t s3  = 2097151 & (basbt::load_4(s + 7) >> 7);
    int64_t s4  = 2097151 & (basbt::load_4(s + 10) >> 4);
    int64_t s5  = 2097151 & (basbt::load_3(s + 13) >> 1);
    int64_t s6  = 2097151 & (basbt::load_4(s + 15) >> 6);
    int64_t s7  = 2097151 & (basbt::load_3(s + 18) >> 3);
    int64_t s8  = 2097151 & basbt::load_3(s + 21);
    int64_t s9  = 2097151 & (basbt::load_4(s + 23) >> 5);
    int64_t s10 = 2097151 & (basbt::load_3(s + 26) >> 2);
    int64_t s11 = 2097151 & (basbt::load_4(s + 28) >> 7);
