...
//--------------------------------------------------------------------------------------------------
static basct::cspan<c32t::element_p3> precomputed_generators_v{};
...
get_precomputed_generators(std::vector<c32t::element_p3>& generators_data, size_t length_generators,
  ...
  basct::span<c32t::element_p3> gen_span;
