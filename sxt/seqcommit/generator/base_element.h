...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
inline void compute_base_element(c21t::element_p3& g, uint64_t index) noexcept {
...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
inline void compute_compressed_base_element(rstt::compressed_element& g_rt, uint64_t index) noexcept {
  c21t::element_p3 g;
