...
void test_pedersen_get_generators(
  ...
  SECTION("we can verify that computed generators are correct when offset is zero") {
    c32t::element_p3 expected_g_0, expected_g_1;
    ...
    c32t::element_p3 generators[num_generators];
    basct::span<c32t::element_p3> span_generators(generators, num_generators);
