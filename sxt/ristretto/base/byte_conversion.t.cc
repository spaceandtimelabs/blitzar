...
TEST_CASE("Testing 4 - point conversion from ristretto to curve255") {
  ...
  SECTION("verify against values from libsodium") {
    ...
    c21t::element_p3 expected_p = {
        .X = {940982861241073, 941784475676028, 1130550519223950, 1055054750816951,
              1217994276021278},
        .Y = {1468150475035081, 1679865258693596, 1553095549552768, 1492975360999298,
              92415319781264},
        .Z = {322327336398557, 2095768576231787, 655955884584774, 1649222581624072,
              857401572457097},
        .T = {1409721664202831, 312686946680975, 697482901591576, 1069363237063803,
              997986709184113},
    };
