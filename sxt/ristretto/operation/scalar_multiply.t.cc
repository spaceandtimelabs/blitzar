...
TEST_CASE("we can multiply elements by a scalar") {
  rstt::compressed_element g{
    226,242,174,10,106,188,78,113,168,
    132,169,97,197,0,81,95,88,227,11,106,165,
  ...
  SECTION("verify multiply by 2") {
    ...
    rstt::compressed_element expected_res{
        106,73,50,16,247,73,156,209,127,236,
        181,16,174,12,234,35,161,16,232,213,185,
        1,248,172,173,211,9,92,115,163,185,25
    };
