...
TEST_CASE("we can accumulate the buckets for a multi-exponentiation 2") {
  ...
  // work around to https://github.com/llvm/llvm-project/issues/67507
  REQUIRE(bascrv::element<E>);
