...
inline bool compute_clumped_output_table(
    mtxi::index_table& table, std::vector<uint64_t>& output_clumps,
    basct::span<basct::span<uint64_t>> rows, size_t num_active_inputs,
    size_t clump_size) noexcept {
  return compute_clumped_output_table(
      table, output_clumps,
