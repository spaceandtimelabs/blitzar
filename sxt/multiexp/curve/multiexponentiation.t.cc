...
TEST_CASE("we can compute multiexponentiations") {
  auto f = [](basct::cspan<c21t::element_p3> generators,
    ...
    return compute_multiexponentiation<c21t::element_p3>(generators, exponents);
  };
...
TEST_CASE("we can compute async multiexponentiations") {
  auto f = [](basct::cspan<c21t::element_p3> generators,
              basct::cspan<mtxb::exponent_sequence> exponents) noexcept {
    auto fut = async_compute_multiexponentiation<c21t::element_p3>(generators, exponents);
