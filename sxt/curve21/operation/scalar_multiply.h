...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
static inline void fill_exponent(s25t::element& a, basct::cspan<uint8_t> data) noexcept {
 ...
 */
CUDA_CALLABLE
inline void scalar_multiply255(c21t::element_p3& h, const unsigned char* a,
 ...
 */
CUDA_CALLABLE
inline void scalar_multiply(c21t::element_p3& h, basct::cspan<uint8_t> a,
                     const c21t::element_p3& p) noexcept {
  assert(a.size() <= 32);
  s25t::element a_p{};
  fill_exponent(a_p, a);
...
inline void scalar_multiply(c21t::element_p3& h, T a, const c21t::element_p3& p) noexcept {
  scalar_multiply(h, basct::cspan<uint8_t>{reinterpret_cast<uint8_t*>(&a), sizeof(a)}, p);
}

inline void scalar_multiply(c21t::element_p3& h, const s25t::element& a,
                     const c21t::element_p3& p) noexcept {
