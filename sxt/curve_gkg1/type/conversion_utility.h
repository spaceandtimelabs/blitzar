 ...
 */
CUDA_CALLABLE
inline void batch_to_element_affine(basct::span<ck1t::element_affine> a,
                                    basct::cspan<ck1t::element_p2> p) noexcept {
 ...
 */
CUDA_CALLABLE
inline void batch_to_element_p2(basct::span<ck1t::element_p2> p,
                                basct::cspan<ck1t::element_affine> a) noexcept {
  SXT_DEBUG_ASSERT(a.size() == p.size());
