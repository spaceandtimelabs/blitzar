...
TEST_CASE("cmov returns the expected projective coordinates") {
  ck1t::element_p2 expect_generator{ck1cn::generator_p2_v};
  ck1t::element_p2 expect_identity{ck1t::element_p2::identity()};

  ck1o::cmov(expect_generator, ck1t::element_p2::identity(), 0);
  ck1o::cmov(expect_identity, ck1t::element_p2::identity(), 1);

  REQUIRE(expect_generator == ck1cn::generator_p2_v);
