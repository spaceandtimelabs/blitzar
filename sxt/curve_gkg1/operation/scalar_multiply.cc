...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
static void scalar_multiply_impl(ck1t::element_p2& h, const ck1t::element_p2& p,
                                 const uint8_t q[32], const int first_one_byte,
                                 const int first_one_bit) noexcept {
  ck1t::element_p2 acc{ck1t::element_p2::identity()};
...
//--------------------------------------------------------------------------------------------------
CUDA_CALLABLE
void scalar_multiply255(ck1t::element_p2& h, const ck1t::element_p2& p,
                        const uint8_t q[32]) noexcept {
